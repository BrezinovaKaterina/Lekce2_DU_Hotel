...
public class Main {
    public static void main(String[] args) {
        ...
        //3. Booking(
        Booking booking1 = new Booking (public void setRoomNumber(room1), public void setGuestFirstName(String guest1), LocalDate.of(2021,7,19), LocalDate.of(2021,7,26));
        //Booking booking2 = new Booking (room3, guest1, LocalDate.of(2021,9,1), LocalDate.of(2021,9,14),otherGuests);
